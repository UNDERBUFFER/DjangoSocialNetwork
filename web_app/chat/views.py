...
class Message(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if request.POST['text'] != '':
            requests.post('http://{}/chat/chat'.format(settings.REST_API_HOST), data={'text': request.POST['text']}, headers={'Authorization': request.COOKIES['Authorization']})
        return self.get(request, *args, **kwargs)
...
class Ignore(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if res is False:
            return self.get(request, *args, **kwargs)
        requests.post('http://{}/chat/ignore'.format(settings.REST_API_HOST), data={'whom': request.POST['whom']}, headers={'Authorization': request.COOKIES['Authorization']})
        return self.get(request, *args, **kwargs)